...
from coworld.native_fixture import build_native_v7_reference_world  # noqa: E402
...
def main() -> None:
    ...
    initial = snapshot_world(
        build_native_v7_reference_world(seed=args.seed, timesteps=args.ticks)
    )
    ...
    for _ in range(args.repeats):
        ...
        if python.snapshot != native.snapshot:
            raise RuntimeError(
                "Python and Nim benchmark runs produced different states"
            )
    ...
    report = {
        ...
        "python": {
            ...
            "median_world_ticks_per_second": python.ticks
            * 1_000_000_000
            / python_median,
        },
        "nim": {
            ...
            "median_world_ticks_per_second": native.ticks
            * 1_000_000_000
            / native_median,
        },
