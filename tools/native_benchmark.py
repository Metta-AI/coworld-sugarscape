...
from coworld.native_fixture import build_native_v4_reference_world  # noqa: E402
...
def main() -> None:
    ...
    initial = snapshot_world(
        build_native_v4_reference_world(seed=args.seed, timesteps=args.ticks)
    )
