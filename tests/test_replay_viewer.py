...
from coworld.scoring import LEGACY_SCORE_METHOD
from coworld.v1_frames import load_catalog, score_against
...
def test_v3_converter_keeps_empty_legacy_measurements_at_zero() -> None:
    ...
    assert score_against(target, empty, LEGACY_SCORE_METHOD) == 0


def test_v1_counterfactual_catalog_excludes_scalar_targets() -> None:
