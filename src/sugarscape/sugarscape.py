...
class Sugarscape:
    def __init__(self, configuration, agent_factory=None):
        self.agentConfigHashes = None
        self.diseaseConfigHashes = None
        self.agentFactory = agent_factory or agent.Agent
    ...
    def configureAgents(self, numAgents, editCell=None):
        ...
        for i in range(numAgents):
            ...
            a = self.agentFactory(agentID, self.timestep, placementCell, agentConfiguration)
            if self.configuration["agentLeader"] == True and self.agentLeader == None:
