"""Reference configuration for native v7 parity and throughput measurements."""
...
def native_v7_config(*, seed: int = 1729, timesteps: int = 10_000) -> dict[str, object]:
    return {
        "seed": seed,
        "seats": 2,
        "timesteps": timesteps,
...
def build_native_v7_reference_world(
    *, seed: int = 1729, timesteps: int = 10_000
) -> CoworldSugarscape:
    resolved = resolve_episode_config(native_v7_config(seed=seed, timesteps=timesteps))
